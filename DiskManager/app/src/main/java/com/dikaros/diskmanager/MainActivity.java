...
import com.dikaros.diskmanager.view.NewFolderDialog;
...
//        Snackbar.make(findViewById(R.id.rlayout_main) ,"已删除",Snackbar.LENGTH_SHORT).show();
        //意图
        Intent intent = new Intent();
        //设置行为
...
//        intent.setData(Uri.parse("mailto:a229732074@gmail.com"));
//        intent.putExtra(Intent.EXTRA_SUBJECT,"主题");
//        intent.putExtra(Intent.EXTRA_TEXT,"内容");
        intent.setAction("com.dikaros.diskmanager.LOGIN");
