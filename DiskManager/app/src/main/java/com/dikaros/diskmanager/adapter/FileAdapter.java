...
import com.dikaros.diskmanager.util.FileSortFactory;
import com.dikaros.diskmanager.util.FileUtils;
...
//        holder.ibMore.setOnClickListener(new FileListItemClickListener(holder.ibMore,position));
    ...
    class ViewHolder {
        ...
        ViewHolder(View v) {
            tvFileName = (TextView) v.findViewById(R.id.tv_file_cell_name);
            tvFileSize = (TextView) v.findViewById(R.id.tv_file_size);
            tvFileTime = (TextView) v.findViewById(R.id.tv_file_cell_time);
            ivFileImage = (ImageView) v.findViewById(R.id.iv_file_cell_image);
            ibMore = (ImageButton) v.findViewById(R.id.ib_file_cell_more);
        }
